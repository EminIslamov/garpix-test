              ...
              <div className="row justify-content-center">
                <div className="col-md-auto">
                  <div className="sales__icon">
                    <img className="icon" src={bkIcon} alt="" />
                  </div>
                </div>
                <div className="col-md-auto">
                  <div className="sales__icon">
                    <img className="icon" src={pyaterochkaIcon} alt="" />
                  </div>
                </div>
                <div className="col-md-auto">
                  <div className="sales__icon">
                    <img className="icon" src={republicIcon} alt="" />
                  </div>
                </div>
                <div className="col-md-auto">
                  <div className="sales__icon">
                    <img className="icon" src={megafonIcon} alt="" />
                  </div>
                </div>
                <div className="col-md-auto">
                  <div className="sales__icon">
                    <img className="icon" src={iviIcon} alt="" />
                  </div>
                </div>
              </div>
            </div>
